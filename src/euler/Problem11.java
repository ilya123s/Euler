...
public class Problem11 {
    ...
    public static void find() {
        long diagonal = 1, horizontal = 1, vertical = 1;
        ...
        for (int x = 0; x <= limit; x++) {
            for (int y = 0; y <= limit; y++) {
                ...
                for (int z = 0; z <= 3; z++) {
                    ...
                    if (diagonal > total) {
                        System.out.println("x " + x + " y " + y + " z " + z);
                        System.out.println("Diagonal " + grid[x][y]);
                        total = diagonal;
                    }
                    if (horizontal > total) {
                        System.out.println("x " + x + " y " + y + " z " + z);
                        System.out.println("Horizontal " + grid[x][y]);
                        total = horizontal;
                    }
                    if (vertical > total) {
                        System.out.println("x " + x + " y " + y + " z " + z);
                        System.out.println("Vertical " + grid[x][y]);
                        total = vertical;
                    }
                }
            }
